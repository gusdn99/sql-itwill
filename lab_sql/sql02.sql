 ...
 */
 ...
 -- 검색 결과를 정렬해서 출력: order by는 항상 맨 마지막에!
 ...
 select deptno, dname from dept order by dname asc; -- asc 생략 가능
 
 -- 부서 테이블에서 부서 이름을 내림차순 정렬 출력
 select deptno, dname from dept order by dname desc; -- desc 생략 불가!
